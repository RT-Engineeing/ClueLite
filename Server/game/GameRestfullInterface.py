                ...
                if playerturnlist.listlength() == 4:
                    ...
                    for i in range(2):
                        ...
                        if i == 0:
                            ...
                            bot1 = Players("bot1", character, bothand, location)
                            node4 = Node(playerturnlist.listlength() + 1, 1, bot1)
                            node4.setready(False)
                            node3.nextval = node4
                            board = newgamestate.getGameBoard()
                            arr = board[bot1.getLocation()[0]][bot1.getLocation()[1]]
                            arr.append(bot1.getCharacter())
                            board[bot1.getLocation()[0]][bot1.getLocation()[1]] = arr
                            newgamestate.setGameBoard(board)
                            session.setGameState(newgamestate)
                        else:
                            newgamestate = session.getGameState()
                            bot2 = Players("bot2", character, bothand, location)
                            node5 = Node(playerturnlist.listlength() + 1, 2, bot2)
                            node5.setready(False)
                            node4.nextval = node5
                            board = newgamestate.getGameBoard()
                            arr = board[bot2.getLocation()[0]][bot2.getLocation()[1]]
                            arr.append(bot2.getCharacter())
                            board[bot2.getLocation()[0]][bot2.getLocation()[1]] = arr
                            newgamestate.setGameBoard(board)
                            session.setGameState(newgamestate)
                if playerturnlist.listlength() == 5:
                    ...
                    for i in range(1):
                        ...
                        if i == 0:
                            newgamestate = session.getGameState()
                            bot1 = Players("bot1", character, bothand, location)
                            node5 = Node(playerturnlist.listlength() + 1, 1, bot1)
                            node5.setready(False)
                            node4.nextval = node5
                            board = newgamestate.getGameBoard()
                            arr = board[bot1.getLocation()[0]][bot1.getLocation()[1]]
                ...
                if playerturnlist.listlength() == 3:
                    ...
                    for i in range(3):
                        ...
                        if i == 0:
                            newgamestate = session.getGameState()
                            bot1 = Players("bot1", character, bothand, location)
                            node3 = Node(playerturnlist.listlength() + 1, 1, bot1)
                            ...
                            newgamestate = session.getGameState()
                            bot2 = Players("bot2", character, bothand, location)
                            node4 = Node(playerturnlist.listlength() + 1, 2, bot2)
                            node4.setready(False)
                            node3.nextval = node4
                            board = newgamestate.getGameBoard()
                            arr = board[bot2.getLocation()[0]][bot2.getLocation()[1]]
                            ...
                            newgamestate = session.getGameState()
                            bot3 = Players("bot3", character, bothand, location)
                            node5 = Node(playerturnlist.listlength() + 1, 3, bot3)
                            node5.setready(False)
                            node4.nextval = node5
                            board = newgamestate.getGameBoard()
                            arr = board[bot3.getLocation()[0]][bot3.getLocation()[1]]
                            arr.append(bot3.getCharacter())
                            board[bot3.getLocation()[0]][bot3.getLocation()[1]] = arr
                            newgamestate.setGameBoard(board)
                            session.setGameState(newgamestate)
                currentNode = playerturnlist.headval
            return jsonify(
